...
#3
apr_data <- read.delim(file = "D:/Winter Semester 2021-22/Data Visualization/Project/Datasets/April Data.csv", header=TRUE,sep=",")
apr_data %>% View()
may_data <- read.delim(file="D:/Winter Semester 2021-22/Data Visualization/Project/Datasets/May Data.csv",header=TRUE,sep=",")
may_data %>% View()
jun_data <- read.delim(file="D:/Winter Semester 2021-22/Data Visualization/Project/Datasets/June Data.csv",header=TRUE,sep=",")
jun_data %>% View()
jul_data <- read.delim(file="D:/Winter Semester 2021-22/Data Visualization/Project/Datasets/July Data.csv",header=TRUE,sep=",")
jul_data %>% View()
aug_data <- read.delim(file="D:/Winter Semester 2021-22/Data Visualization/Project/Datasets/August Data.csv",header=TRUE,sep=",")
aug_data %>% View()
sep_data <- read.delim(file="D:/Winter Semester 2021-22/Data Visualization/Project/Datasets/September Data.csv",header=TRUE,sep=",")
sep_data %>% View()
